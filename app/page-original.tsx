...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[rgb(19,17,28)] to-[rgb(13,13,20)] text-white relative overflow-x-hidden">
      ...
      <section className="h-screen flex items-center justify-center px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto text-center">
          <motion.h1 
            className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight"
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
      ...
      <section id="problem" className="py-20 px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div 
            ...
            animate={hasAnimated ? staggerContainer.animate : staggerContainer.initial}
          >
            {[
      ...
      {/* Solution Section */}
      <section id="solution" className="py-20 px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <motion.h2 
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-16"
            initial={fadeInUp.initial}
          ...
          >
            {[
              ...
              <motion.div
                ...
                initial={fadeInUp.initial}
                animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
                transition={{ ...fadeInUp.transition, delay: 1.6 + index * 0.1 }}
              >
      ...
      {/* Mid-Page CTA */}
      <section className="py-20 px-6 lg:px-8 bg-gradient-to-r from-purple-900/20 to-pink-900/20 relative">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2 
            className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6"
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 2.0 }}
          >
          ...
          <motion.button
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 2.4 }}
          >
            Jump to Pricing
          </motion.button>
        </div>
      ...
      <section className="py-20 px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <motion.h2 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 2.6 }}
          >
          ...
          >
            {[
              ...
              <motion.div
                ...
                initial={fadeInUp.initial}
                animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
                transition={{ ...fadeInUp.transition, delay: 2.8 + index * 0.2 }}
              >
      ...
      {/* The Offer Section */}
      <section id="offer" className="py-20 px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <motion.h2 
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-6"
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 3.2 }}
          >
          ...
          <motion.p 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 3.4 }}
          >
          ...
          >
            <motion.div 
              ...
              initial={fadeInUp.initial}
              animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
              transition={{ ...fadeInUp.transition, delay: 3.6 }}
            >
            ...
            <motion.div 
              ...
              initial={fadeInUp.initial}
              animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
              transition={{ ...fadeInUp.transition, delay: 3.8 }}
            >
            ...
            <motion.div 
              ...
              initial={fadeInUp.initial}
              animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
              transition={{ ...fadeInUp.transition, delay: 4.0 }}
            >
          ...
          <motion.div 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 4.2 }}
          >
          ...
          <motion.div 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 4.4 }}
          >
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto">
          <motion.div 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 4.6 }}
          >
            {/* Enhanced Ribbon */}
      ...
      <section className="py-20 px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 4.8 }}
          >
          ...
          <motion.p 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 5.0 }}
          >
          ...
          <motion.button
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 5.2 }}
          >
      ...
      <section id="contact" className="py-20 px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 5.4 }}
          >
          ...
          <motion.p 
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 5.6 }}
          >
          ...
          <motion.a
            ...
            initial={fadeInUp.initial}
            animate={hasAnimated ? fadeInUp.animate : fadeInUp.initial}
            transition={{ ...fadeInUp.transition, delay: 5.8 }}
          >
            arsalmaab@gmail.com
          </motion.a>
        </div>
